...
let fixpoint_message indexes l =
  Flags.if_verbose msgnl (tag "normalresponse" [("type", "fixpoint")] (match l with
...
let cofixpoint_message l =
  Flags.if_verbose msgnl (tag "normalresponse" [("type", "cofixpoint")] (match l with
...
let definition_message id =
  Flags.if_verbose msgnl (tag "normalresponse" [("type", "definition")] (pr_id id ++ str " is defined"))

let assumption_message id =
  Flags.if_verbose msgnl (tag "normalresponse" [("type", "assumption")] (pr_id id ++ str " is assumed"))
